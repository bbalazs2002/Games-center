...
**Státusz:** Implementálva (motor + 3D renderer + hot-seat UI), `tsc`/`eslint`/`vitest`/`vite build` mind zöld — több élő böngészős/hot-seat playtest-kör is lezajlott (lásd a 9. szakasz "Xdik kérés" bejegyzéseit, legutóbb 2026-08-03).
