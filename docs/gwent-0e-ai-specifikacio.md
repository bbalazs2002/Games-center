...
- **Kürt-jellegű sor-duplázás** (`hornDoubleOwnRow` család: Foltest The Siegemaster / Eredin King of the Wild Hunt / Francesca The Beautiful — felhasználói korrekció, 2026-08-07: eredetileg tévesen Category B-nek tervezve, lásd 13. szakasz) — nincs explicit döntési szabály rá, mert nem is kell: a `leaderAbilityCandidates`-ben a `default: return [base]` ág már felkínálja jelöltként (nincs cél-paramétere), a valódi reducert futtató kiértékelés pedig magától felismeri, hogy a duplázott sor jobb pontszámot ad — pontosan úgy, mint a Kéz-felfedésnél.

Ezek a szabályok együtt mind a 16 Category A képességet lefedik. A Category B (passzív, pl. Eredin Breacc Glas The Treacherous Spy-duplázása) és Category C (automatikus, pl. Francesca Daisy of the Valley extra kezdőlapja) kategóriák nem igényelnek AI-döntést, hiszen nem aktiválandó képességek — automatikusan/mindig érvényesülnek, az AI számára ugyanúgy, mint egy emberi játékosnál.
